...
use Grocery\Controller\GroceryDashboardController;
...
class GroceryDashboardControllerFactory implements FactoryInterface {
     ...
     public function createService(ServiceLocatorInterface $serviceLocator)
    {
        ...
        return new GroceryDashboardController($em, $cis, $vhm, $ps, $pls, $pis);
    }
